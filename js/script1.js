//https://pastebin.com/HDNKnw80

$(function(){
    var carouselList = $("#carousel ul");
    var indicatorList = $(".carousel-indicator ul");
    // var indicatorItem = indicatorList.find("li:first"); //kontrolki
    var indicatorItem = indicatorList.find("li"); //kontrolki
    var i = 100000;
    indicatorItem.css({'list-style-type':'circle'}); //ustawienie 1-szej kulki kontrolki na pełną
...
function changeSlide(msTime) {
    ...
    $(indicatorItem.toArray()[i % 5]).css({'list-style-type':'disc'}); //ustawienie następnej kulki na pełną
